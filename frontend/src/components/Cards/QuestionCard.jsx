            ...
            <div className="flex items-start gap-3.5">
                ...
                <div className="flex items-center justify-end ml-4 relative">
                    ...
                    >
                        ...
                        <button className="flex items-center gap-2 text-xs text-cyan-800 font-medium bg-cyan-50 px-3 py-1 mr2 rounded text-nowrap border border-cyan-50 hover:border-cyan-200 cursor-pointer"
                        onClick={()=>{
                            setIsExpanded(true);
                            onLearnMore();
                        }}
